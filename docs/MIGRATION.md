...
| Activity   | 11550–12625, 9049–10236  | 🟡 My tasks (mine = assigned to me or to my role and untaken), Everyone / per person, Overdue · Today · Upcoming · No date, search incl. SB ref, create, done/reopen, withdraw/put back with reason, hand over to a person or a role, Monday-first month calendar, booking Tasks tab, tasks withdrawn when their booking is cancelled | document rules engine (DOC_RULES: anchors, working days, holidays), away & cover, blocking-task banner |
